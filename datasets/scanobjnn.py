...
class ScanObjectNN(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        #train_data, train_label = self.load_data(os.path.join(self.dataset_dir, 'train_files_obj.txt'))
        #test_data, test_label = self.load_data(os.path.join(self.dataset_dir, 'test_files_obj.txt'))

        train_data, train_label = self.load_data(os.path.join(self.dataset_dir, 'train_files_obj_bg.txt'))
        test_data, test_label = self.load_data(os.path.join(self.dataset_dir, 'test_files_obj_bg.txt'))
