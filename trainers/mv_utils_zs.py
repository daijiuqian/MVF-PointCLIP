...
class Realistic_Projection:
    ...
    def __init__(self):
        ...
        # _views = np.asarray([
        #     [[1 * np.pi / 8, 0, np.pi / 2], [-0.5, -0.5, TRANS]],
        ...
        #     [[np.pi / 4, np.pi / 4, np.pi / 2], [-0.5, -0.5, TRANS]],
        #     [[3 * np.pi / 4, np.pi / 4, np.pi / 2], [-0.5, -0.5, TRANS]],
        #     [[5 * np.pi / 4, np.pi / 4, np.pi / 2], [-0.5, -0.5, TRANS]],
        #     [[7 * np.pi / 4, np.pi / 4, np.pi / 2], [-0.5, -0.5, TRANS]],
        #     [[np.pi, np.pi / 4, np.pi / 2], [-0.5, -0.5, TRANS]],
        # ])
